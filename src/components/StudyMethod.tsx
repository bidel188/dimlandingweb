  ...
  return (
    <section className="bg-white py-20 lg:py-24">
      <div className="mx-auto max-w-7xl px-6">
        ...
        <div className="relative mt-12 grid grid-cols-1 gap-10 overflow-hidden rounded-3xl bg-gradient-to-br from-sky-50 to-indigo-50 p-8 lg:grid-cols-2 lg:p-12">
          <Blob className="-right-16 -top-16 h-64 w-64 text-brand-orange/10 blur-3xl" />
